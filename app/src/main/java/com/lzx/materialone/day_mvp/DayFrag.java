...
public class DayFrag extends Fragment implements IDayFrag, View.OnLongClickListener, View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        rootView = (LinearLayout) view.findViewById(R.id.fd_root_layout);
        Bundle bundle = getArguments();
        if (bundle != null && !bundle.isEmpty()){
            presenter = new Presenter(this, bundle.getInt("day", 0));
            Log.d("pager", "fragment : " + bundle.getInt("day", 0));
    ...
    @Override
    public void setContentItem(View view, String category, String picUrl, String title, String author, String abstracts,
